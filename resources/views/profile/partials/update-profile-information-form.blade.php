<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            {{ __('Профільна інформація') }}
        </h2>

        <p class="mt-1 text-sm text-gray-600">
            {{ __("Оновіть інформацію про свій обліковий запис та адресу електронної пошти.") }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="email" :value="__('Електронна пошта (Email)')" />
